...
public class DockerContainerStartCommand extends CommandExecutor {
    private OperationRepresentation operation;
    private String containerID;

    public DockerContainerStartCommand(OperationRepresentation operation, String containerID) {
    ...
    public BufferedReader execute() {
        ...
        try {
            result = this.systemCall("docker", "container", "start", this.containerID);
